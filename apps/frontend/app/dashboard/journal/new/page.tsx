...
export default function NewJournalEntryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAlert({ type: 'success', message: 'Entrada salva com sucesso! 🎉' });
      setTimeout(() => {
      ...
      setAlert({
        type: 'error',
        message: error.response?.data?.message || 'Erro ao salvar entrada do diário',
      });
    } finally {
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <h1 className="text-xl font-semibold text-gray-900">Nova Entrada</h1>
            <div className="w-32" />
          </div>
        </div>
      </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                placeholder="Escreva livremente sobre seus pensamentos, sentimentos ou experiências do dia..."
                rows={12}
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-gray-500">Seus dados são privados e seguros.</p>
            </div>
          </form>
        </div>
      </main>
